...
//            LogUtils.d(TAG, "writeExternal: " +  dcim);
//
...
//            LogUtils.d(TAG, "writeExternal: " + picPath);
//
...
//            LogUtils.d(TAG, "writeExternal: " + en_dcim);
            ...
            filename = Canstant.SD_CARD + File.separator +filename;
            LogUtils.d(TAG, "writeExternal: " + filename);
    ...
    public static String readExternal(Context context, String filename) throws IOException {
        ...
        if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
            //filename = context.getExternalCacheDir().getAbsolutePath() + File.separator + filename;
            filename = Canstant.SD_CARD +filename;
            LogUtils.d(TAG, "readExternal: " + filename);
            //打开文件输入流
    ...
    public static void writeInternal(Context context, String filename, String content) throws IOException {
        ...
        LogUtils.d(TAG, "writeInternal: " + filename);
        //打开文件输入流
        FileOutputStream outputStream = new FileOutputStream(filename);
    ...
    public static String readInternal(Context context, String filename) throws IOException {
        ...
        LogUtils.d(TAG, "readInternal: " + cachePath);
